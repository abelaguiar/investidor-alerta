  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">APROVAR USUÁRIOS</h4>
...
<div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <img src="http://minible-h-light.laravel.themesbrand.com/assets/images/users/avatar-2.jpg" alt="" class="avatar-lg rounded-circle img-thumbnail">
                    </div>
                ...
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-outline-light text-truncate"><i class="uil-check-circle
"></i>
                        Aprovar</button>
                    <button type="button" class="btn btn-outline-light text-truncate"><i class="uil-times-circle
"></i> Não Autorizar</button>
