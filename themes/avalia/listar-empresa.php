        ...
        <div class="row">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">LISTAR EMPRESAS</h4>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                          <thead>
                            <tr role="row">
                              <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 80%;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Empresa</th>
							  <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 80%;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Site</th>
                              <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 20%;" aria-label="Position: activate to sort column ascending">Ações</th>
                          </thead>
                          <tbody>
                            <tr class="odd">
                              <td class="dtr-control sorting_1" tabindex="0">Canal de Alta</td>
							  <td class="dtr-control sorting_1" tabindex="0">www.canaldealta.com.br</td>
                              <td><button type="button" class="btn btn-success waves-effect waves-light"> <i class="uil uil-check me-2"></i> EDITAR </button>
                                <button type="button" class="btn btn-danger waves-effect waves-light"> <i class="uil uil-exclamation-octagon me-2"></i> EXCLUIR </button></td>
                            </tr>
							<tr class="odd">
                              <td class="dtr-control sorting_1" tabindex="0">Canal de Alta</td>
							    <td class="dtr-control sorting_1" tabindex="0">www.canaldealta.com.br</td>
