                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card">
                            ...
                            <div class="card-body p-4"> 
                                ...
                                <div class="p-2 mt-4">
                                    <form action="cadastro-representantes.php">
										...
										<div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Coloque seu email">
                                        </div>
...
<!-- Mirrored from themesbrand.com/minible/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 May 2021 13:44:13 GMT -->
</html>
