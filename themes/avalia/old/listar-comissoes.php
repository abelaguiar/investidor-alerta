    ...
    <div class="row">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title mb-4">Buscar Comissões</h4>
				<div class="mb-3 row">
              <label class="col-md-2 col-form-label">Selecionar Mês</label>
              <div class="col-md-10">
                  ...
                  <div data-repeater-item="" class="outer">
                    <div class="inner-repeater mb-4">
                      <div data-repeater-list="inner-group" class="inner form-group">
                        <label class="form-label">Digite o nome da loja/representante</label>
                        <div data-repeater-item="" class="inner mb-3 row">
                          <div class="col-md-10 col-8">
                            <input type="text" class="inner form-control" placeholder="Digite aqui...">
                          </div>
            ...
            <div class="table-responsive">
              <table class="table table-borderless mb-0">
                <thead>
                  <tr>
                    <th width="4%">#</th>
                    <th width="25%" align="Left">Nome Representante</th>
                    <th width="23%" align="Left">Estado</th>
                    <th width="26%" align="Left">Loja</th>
                    <th width="22%" align="Left">Valor</th>
