      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title-desc">Cadastre sua comissão.</p>
			  <div class="mb-3 row">
              <label class="col-md-2 col-form-label">Selecionar Mês da Comissão</label>
              <div class="col-md-10">
			  ...
			  <div class="mb-3 row">
              <label class="col-md-2 col-form-label">Loja</label>
              <div class="col-md-10">
                <select class="form-select">
			  ...
			  <div class="mb-3 row">
              <label class="col-md-2 col-form-label">Representante</label>
              <div class="col-md-10">
                <select class="form-select">
                  <option>Selecionar Representante</option>
                  <option>Large select</option>
                  <option>Small select</option>
                </select>
              </div>
            ...
            <div class="mb-3 row">
              <label for="example-text-input" class="col-md-2 col-form-label">Valor</label>
              <div class="col-md-10">
                <input class="form-control" type="text" value="R$ Digite o valor" id="example-text-input">
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              <label for="example-datetime-local-input" class="col-md-2 col-form-label">Status da Comissão</label>
              <div class="col-md-10">
                <input type="checkbox" id="switch3" switch="bool" checked="">
                <label for="switch3" data-on-label="Pago" data-off-label="Pendente"></label>
              </div>
            </div>
            <div class="mt-3">
              <label class="form-label">Detalhes</label>
              <p class="text-muted mb-2"> Descreva suas Observações </p>
            ...
            <br>
            <button type="button" class="btn btn-success waves-effect waves-light"> <i class="uil uil-check me-2"></i> Cadastrar Comissão </button>
