                ...
                <div class="col-sm-6 col-lg-4">
                                        <div class="card text-center">
                                            <div class="card-body" style="padding: 50px">
                                               <h1 class="display-6 mb-0">NOME EMPRESA</h1><br>
											  <a href="empresas-avalia.php"> <button type="button" class="btn btn-outline-secondary waves-effect">Ver Avaliações</button></a>
									...
									<div class="col-sm-6 col-lg-4">
                                        <div class="card text-center">
                                            <div class="card-body" style="padding: 50px">
                                               <h1 class="display-6 mb-0">NOME EMPRESA</h1><br>
											   <button type="button" class="btn btn-outline-secondary waves-effect">Ver Avaliações</button>
