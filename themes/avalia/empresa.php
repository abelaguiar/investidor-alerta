...
<BR><BR>
                    <div class="mb-3 row">
                        <label for="example-text-input" class="col-md-2 col-form-label">Nome da Empresa</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="" id="example-text-input">
                        </div>
                    </div>
					<div class="mb-3 row">
                        <label for="example-text-input" class="col-md-2 col-form-label">Site da Empresa</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="" id="example-text-input">
                        </div>
                    </div>
					...
					<button type="button" class="btn btn-success waves-effect waves-light">
                            <i class="uil uil-check me-2"></i> Cadastrar
                        </button>
                </div>
            </div>
        </div>
