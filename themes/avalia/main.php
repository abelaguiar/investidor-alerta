  ...
  <div class="main-content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="" style="position: relative;">
                     <h1 class="display-5"><span data-plugin="counterup" style="color: #1c9e02"> 75</span><span style="color: #1c9e02">%</span></h1>
   ...
   <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                <div class="" style="position: relative;">
                  <h1 class="display-5"><span data-plugin="counterup" style="color: #ec0a0a"> 25</span><span style="color: #ec0a0a">%</span></h1>
				<div class="resize-triggers"><div class="expand-trigger"><div style="width: 46px; height: 47px;"></div></div><div class="contract-trigger"></div></div></div>
                <div>
